...
from arctic_platform.client.cortex.tui.format import format_created_at
from arctic_platform.client.cortex.tui.format import format_event
...
from arctic_platform.client.cortex.tui.format import format_job_summary
...
def test_format_structured_log_entry():
    line = format_log_entry({"ts": "2026-06-12T00:00:01Z", "level": "INFO", "logger": "dss.zones", "msg": "hello"})
