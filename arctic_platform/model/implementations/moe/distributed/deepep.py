...
def register_deepep_cuda_ops() -> None:
    ...
    _deepep_cuda_lib = torch.library.Library("ap_deepep", "DEF")
    ...
    torch.library.register_autograd("ap_deepep::dispatch", _dispatch_backward, setup_context=_dispatch_setup_context)
...
def finalize_dispatch_tokens(
    ...
    hidden_states, permuted_scores, permuted_indices, num_tokens_per_expert = permute_tokens(
        ...
        pending_state.num_tokens_per_expert.numel(),
    )
