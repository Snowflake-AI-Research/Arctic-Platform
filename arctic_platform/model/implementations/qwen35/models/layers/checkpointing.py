...
# Module prefix used to decide whether a decoder layer is a carved-out custom
# model that supports the selective-AC hook contract above.
_CUSTOM_MODEL_MODULE_PREFIX = __name__.rsplit(".", 2)[0] + "."
...
def supports_selective_activation_checkpointing(layer: nn.Module) -> bool:
    return type(layer).__module__.startswith(_CUSTOM_MODEL_MODULE_PREFIX)
