...
try:
    ...
    FLASH_ATTN_CROSS_ENTROPY_LOSS_AVAILABLE = True  # noqa: F841 — kept for any external readers
except ImportError:
    FLASH_ATTN_CROSS_ENTROPY_LOSS_AVAILABLE = False

# CE / tiled logprob kernels live in ``common.utils.tiled_logits`` (imported near
# the bottom under historical names). The flag above is no longer consulted here.
